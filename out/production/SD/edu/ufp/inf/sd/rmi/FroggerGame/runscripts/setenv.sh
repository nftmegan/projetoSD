...
#@REM =====================================================================================================
# @REM ==== PC STUFF ====
export JDK=/Library/Java/JavaVirtualMachines/jdk1.8.0_311.jdk/Contents/Home
#export JDK=/System/Library/Java/JavaVirtualMachines/jdk-18.jdk/Contents/Home
...
export USERNAME=franciscogiestas
...
export SERVICE_NAME_ON_REGISTRY=FroggerService
...
export CLIENT_CLASS=FroggerClient
export SERVER_CLASS=FroggerServer
...
export PROJECT_LIBS=${JAVAPROJ_DIST_LIB_FOLDER}/jig-1.7.5.jar:${JAVAPROJ_DIST_LIB_FOLDER}/ogg-spi/jogg-0.0.7.jar:${JAVAPROJ_DIST_LIB_FOLDER}/ogg-spi/jorbis-0.0.15.jar:${JAVAPROJ_DIST_LIB_FOLDER}/ogg-spi/tritonus_jorbis-0.3.6.jar:${JAVAPROJ_DIST_LIB_FOLDER}/spi/tritonus_share.jar

export CLASSPATH=.:${JAVAPROJ_CLASSES_FOLDER}:${PROJECT_LIBS}
