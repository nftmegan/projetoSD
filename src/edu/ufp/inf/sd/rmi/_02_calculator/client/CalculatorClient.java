...
public class CalculatorClient {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 2) {
            System.err.println("usage: java [options] edu.ufp.sd.inf.rmi._02_calculator.server.HelloWorldClient <rmi_registry_ip> <rmi_registry_port> <service_name>");
            System.exit(-1);
        } else {
    ...
    private void playService() {
        try {
            ...
            double res = this.calculatorRI.add(1, 2);
            String resStr = "RESULADO " + String.valueOf(res);

            Logger.getLogger(this.getClass().getName()).log(Level.INFO, resStr);
